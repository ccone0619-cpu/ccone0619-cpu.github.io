...
window.PORTFOLIO_CONTENT = {
  ...
  resume: {
    eyebrow: "我的经历与能力",
    title: "我负责什么，\n我做出过什么。",
    intro: "我现居杭州，20 岁。参与多部红果上线短剧，能够独立推进所分配剧集，并完成从分镜到成片的交付。",
    fileNote: "PDF · 个人简历",
    facts: [
      { label: "我的方向", value: "视频剪辑 · 内容制作" },
      { label: "我的经验", value: "多部红果上线短剧" },
      { label: "我的成绩", value: "参与项目进入新剧榜第 4 名" },
      { label: "我的优势", value: "独立推进分配剧集至成片" }
    ],
    ...
    experience: [
      ...
      {
        meta: "我串联",
        title: "把分镜、资产与视频生成连成流程",
        role: "分镜拆解 · 视觉统一 · 动态生成",
        body: "我根据剧情拆解镜头，组织角色、场景和画面资产，控制人物与镜头的一致性，再推进到动态素材生成，减少环节之间的返工。"
      },
      {
        meta: "我完成",
        title: "用剪辑把素材变成完整叙事",
